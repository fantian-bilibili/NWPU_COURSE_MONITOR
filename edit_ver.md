...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) [![Release: v1.0.1](https://img.shields.io/badge/Release-v1.0.1-blue.svg)](https://github.com/fantian-bilibili/NWPU_COURSE_MONITOR/releases/tag/v1.0.1)
...
- 教务导入
    - 移动端内置 WebView 导入，兼容翱翔教务系统页面解析逻辑，支持提取后的 payload / HTML 快照导入，方便快捷地导入课程信息。
- 成绩与 GPA
  - 课程可绑定绩点，自动计算当前学分绩与已计入学分，帮助同学们更好地了解自己的学业情况。
- 导入导出
